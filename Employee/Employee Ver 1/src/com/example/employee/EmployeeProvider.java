...
public class EmployeeProvider extends ContentProvider {
	...
	private static final String CLASSNAME = EmployeeProvider.class.getSimpleName();
	...
	static {
		 ...
		 EmployeeProvider.URI_MATCHER.addURI(Employee.AUTHORITY, Employee.PATH_MULTIPLE, EmployeeProvider.EMPLOYEES_CODE);
		 EmployeeProvider.URI_MATCHER.addURI(Employee.AUTHORITY, Employee.PATH_SINGLE, EmployeeProvider.EMPLOYEE_CODE);
	...
	private static class DBOpenHelper extends SQLiteOpenHelper { 
		...
		private static final String DB_CREATE = "CREATE TABLE " + EmployeeProvider.DB_TABLE
				+ " (_id INTEGER PRIMARY KEY, "+Employee.NAME+" TEXT NOT NULL, "+Employee.SURNAME+" TEXT);";
	    // private static final String DB_UPDATE = "";
		public DBOpenHelper(final Context context) {
			super(context, EmployeeProvider.DB_NAME, null, EmployeeProvider.DB_VERSION);			
	    }
		 
		@Override
		public void onCreate(final SQLiteDatabase db) {
			Log.v(LOGTAG, EmployeeProvider.CLASSNAME + " OpenHelper Creating database");
			try {
	     ...
	     public void onOpen(final SQLiteDatabase db) {
			 super.onOpen(db);
	         Log.v(LOGTAG, EmployeeProvider.CLASSNAME + " OpenHelper Opening database");
	     }
		 
		 @Override
	     public void onUpgrade(final SQLiteDatabase db, final int oldVersion, final int newVersion) {
			 Log.w(LOGTAG, EmployeeProvider.CLASSNAME + " OpenHelper Upgrading database from version " 
	...
	public Uri insert(final Uri uri, final ContentValues initialValues) {
        ...
        if (EmployeeProvider.URI_MATCHER.match(uri) != EmployeeProvider.EMPLOYEE_CODE) {
        ...
        if (rowId > -1) {// If not error.
            Uri result = ContentUris.withAppendedId(Employee.CONTENT_URI, rowId);
            return result;
        }
        throw new SQLException("Failed to insert row into " + uri);
	}
	
    public List<Review> queryEmployees(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs,final String sortOrder) {   	
